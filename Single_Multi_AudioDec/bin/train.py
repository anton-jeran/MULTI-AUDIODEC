...
class TrainGAN(abc.ABC):
    ...
    def _show_setting(self):
        ...
        logging.info(self.model['discriminator_speech'])
        logging.info(self.model['discriminator_rir'])
        logging.info(self.optimizer['generator'])
        logging.info(self.optimizer['discriminator_speech'])
        logging.info(self.optimizer['discriminator_rir'])
        logging.info(self.scheduler['generator'])
        logging.info(self.scheduler['discriminator_speech'])
        logging.info(self.scheduler['discriminator_rir'])
